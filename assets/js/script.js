...
$(".card .list-group").sortable({
  ...
  update: function (event) {
    ...
    var tempArr = []
    // loop over current set of children in sortable list (nested 'this' 1 refers to #list-group, 2nd to children of list-group )
...
//repeat auditTask function at a given time interval. goes thru each element with class list-group-item and audits each one
